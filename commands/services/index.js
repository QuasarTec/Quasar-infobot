    ...
    if (action === 'service_connect') {
        ...
        if (res !== true) {
            ...
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_connect' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_qcloud' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_message' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_franchise' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_insta_comment' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_insta_lead' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_skype_lead' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_skype_reg' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_tele_lead' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_vk_lead' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_vk_reg' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_autopilot' }]],
            };
        }
        return sending_msg;
        ...
        if (res !== true) {
            sending_msg.text = res;
            sending_msg.opts.reply_markup = {
                inline_keyboard: [[{ text: 'Назад', callback_data: 'service_insta_king' }]],
            };
        }
        return sending_msg;
